...
struct FacialRecogniser {
  FacialRecogniser(shared_ptr<TrackerData> data) {
    Data = data;
    face.load("/home/shane/naruto-beatspeak/BeatReq/cascade/"
              "haarcascade_frontalface_alt.xml");
    eyes.load(
        "/home/shane/naruto-beatspeak/BeatReq/cascade/haarcascade_eye.xml");
    mouth.load(
        "/home/shane/naruto-beatspeak/BeatReq/cascade/haarcascade_smile.xml");
  }
